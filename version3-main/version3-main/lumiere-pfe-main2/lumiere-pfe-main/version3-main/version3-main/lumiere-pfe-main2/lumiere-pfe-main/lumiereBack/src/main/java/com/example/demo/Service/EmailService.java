...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String to, String code) {
        ...
        String title = "Code de réinitialisation";
        String message = "Bonjour,<br><br>" +
                "Vous avez demandé la réinitialisation de votre mot de passe. Voici votre code de validation : <br><br>" +
                "<div style='text-align: center; font-size: 24px; font-weight: bold; letter-spacing: 5px; color: #f07020; margin: 20px 0;'>" + code + "</div><br>" +
                "Vous pouvez utiliser ce code dans l'application ou cliquer sur le lien ci-dessous si vous utilisez la version Web :<br><br>" +
                "<a href='http://localhost:4200/auth/reset-password?email=" + to + "&code=" + code + "'>Lien de réinitialisation</a><br><br>" +
                "Si vous n'avez pas demandé cette réinitialisation, vous pouvez ignorer cet e-mail.";

        String htmlContent = generateGenericHtml(title, message, "Réinitialiser");
        try {
            sendHtmlEmailWithLogo(to, subject, htmlContent);
        } catch (MessagingException e) {
